...
import { Card, CardHeader, Avatar, CardContent, Typography, IconButton, CardActions } from '@mui/material';
...
// açıklama değiştirme
    ...
    return (
        <>
            ...
            {kontrol ? <div >
               <Card className='form-post' sx={{ maxWidth : 1000 }}>
